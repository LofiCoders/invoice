    ...
    <div class="py-12 ml-2 mr-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                <div
                    class="relative overflow-hidden rounded-lg bg-indigo-300 px-4 pb-12 pt-5 shadow sm:px-6 sm:pt-6">
                    <dt>
                        <div class="absolute rounded-md bg-sky-blue p-3">
                        ...
                        <p class="ml-16 truncate text-sm font-medium text-gray-500">Total Invoices</p>
                    </dt>
                    <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
                        ...
                        <div class="absolute inset-x-0 bottom-0 bg-gray-50 px-4 py-4 sm:px-6">
                            <div class="text-sm">
                                <a href="{{ route('account.invoices.index') }}" class="font-medium text-indigo-600 hover:text-indigo-500"> View
                ...
                <div class="relative overflow-hidden rounded-lg bg-white px-4 pb-12 pt-5 shadow sm:px-6 sm:pt-6">
                    <dt>
                        ...
                        <p class="ml-16 truncate text-sm font-medium text-gray-500">Total Customers</p>
                    </dt>
                    <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
                ...
                <div class="relative overflow-hidden rounded-lg bg-white px-4 pb-12 pt-5 shadow sm:px-6 sm:pt-6">
                    <dt>
                        ...
                        <p class="ml-16 truncate text-sm font-medium text-gray-500">Total products</p>
                    </dt>
                    <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
                        ...
                        <div class="absolute inset-x-0 bottom-0 bg-gray-50 px-4 py-4 sm:px-6">
                            <div class="text-sm">
                                <a href="{{ route('account.products.index') }}"
                                    class="font-medium text-indigo-600 hover:text-indigo-500"> View
                                    all<span class="sr-only"> View all products</span></a>
                            </div>
                        </div>
                    </dd>
                </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <x-recent-customers-component />
            <x-recent-products-component />
            <x-recent-invoices-component />
