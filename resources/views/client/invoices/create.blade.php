<x-app-layout>
    ...
    <div class="max-w-8xl mx-auto sm:px-8 lg:px-12 mr-2 ml-2">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">

	<div 
		class="container mx-auto py-9 px-12"
		x-data="invoices()"
	...
	>
		...
		<div id="js-print-template" x-ref="printTemplate" class="hidden">
			...
			<div class="py-2 ml-auto mt-20" style="width: 320px">
				...
				<div class="flex justify-between mb-4">
					<div class="text-sm text-gray-600 text-right flex-1">Tax in VAT(18%) incl. in Total</div>
					<div class="text-right w-40">
						<div class="text-sm text-gray-600" x-html="totalGST"></div>
					</div>
				</div>
