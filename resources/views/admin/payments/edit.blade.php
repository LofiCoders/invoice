    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.payments.update", [$payment->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stripeid') ? 'is-invalid' : '' }}" type="text" name="stripeid" id="stripeid" value="{{ old('stripeid', $payment->stripeid) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax') ? 'is-invalid' : '' }}" type="number" name="tax" id="tax" value="{{ old('tax', $payment->tax) }}" step="1">
                @if($errors->has('tax'))
                    <div class="invalid-feedback">
                        {{ $errors->first('tax') }}
                    </div>
