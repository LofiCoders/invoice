            ...
            <ul role="list" class="flex flex-1 flex-col gap-y-7">
                <li>
                    <ul role="list" class="-mx-2 space-y-1">
                        ...
                        <li>
                            <x-nav-link :href="route('account.products.index')" :active="request()->routeIs('account.products.index')|| request()->is('account/products/*')">
                        ...
                        <li>
                            <x-nav-link :href="route('account.customers.index')" :active="request()->routeIs('account.customers.index') || request()->is('account/customers/*')">
                                <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                             stroke="currentColor" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li>
                            <x-nav-link :href="route('account.invoices.index')" :active="request()->routeIs('account.invoices.index') || request()->is('account/invoices/*')">
                        ...
                        <li>
                            <x-nav-link :href="route('account.reports')" :active="request()->routeIs('account.reports') || request()->is('account/reports/*')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <li>
                    <div class="text-xs font-semibold leading-6 text-gray-400">Your Account</div>
                    <ul role="list" class="-mx-2 mt-2 space-y-1">
                        <li>
                            <x-nav-link :href="route('billing.index')" :active="request()->routeIs('billing.index')|| request()->is('/billing/*')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
