                        ...
                        <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                            ...
                            <figcaption class="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                                ...
                                <div class="overflow-hidden rounded-full bg-slate-50">
                                    <img alt="" src="" width="56" height="56" decoding="async" data-nimg="1" class="h-14 w-14 object-cover" loading="lazy" style="color:transparent">
                                </div>
                            </figcaption>
                        </figure>
                    </li>
                ...
                <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8">
                    <li>
                        <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                            ...
                            <blockquote class="relative">
                                <p class="text-lg tracking-tight text-slate-900">
                                    The best part about TaxPal is every time I pay my employees, my bank balance
                                    doesn’t go down like it used to. Looking forward to spending this extra cash
                            ...
                            <figcaption class="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                                ...
                                <div class="overflow-hidden rounded-full bg-slate-50">
                                    <img alt="" src="" width="56" height="56" decoding="async" data-nimg="1" class="h-14 w-14 object-cover" loading="lazy" tyle="color:transparent">
                                </div>
                            </figcaption>
                        </figure>
                    </li>
